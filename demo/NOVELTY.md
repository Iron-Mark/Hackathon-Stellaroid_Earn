...
## The three-in-one primitive

| Primitive | What it usually looks like | What Stellaroid Earn does |
|---|---|---|
...
- **29%** of freelance invoices are paid late; **21%** of freelancers get paid late (or never) more than half the time. [Bonsai](https://www.hellobonsai.com/blog/late-freelance-payment)
- **Women** are paid late **31%** of the time vs. **24%** for men. [Bonsai](https://www.hellobonsai.com/blog/late-freelance-payment)
- Small businesses are owed **$17.5K on average** in unpaid invoices. [QuickBooks, 2025](https://quickbooks.intuit.com/r/small-business-data/small-business-late-payments-report-2025/)

**Atomic pay-on-verify eliminates the 30–60 day wait. The transaction is the proof.**

### Platforms tax the worker 12–20%
...
- **64.2%** of Americans admit lying on a resume. **32%** misrepresent education. **18%** fabricate degrees entirely. [AMS Inform](https://www.amsinform.com/workplace/10-shocking-statistics-about-resume-fraud/)
- **2,600+ diploma mills** operate globally. The fake-diploma industry is worth **$21B/year**. [Education Verification, 2024](https://www.education-verification.com/the-global-rise-of-fake-degrees-six-major-scandals-in-2024/)
- An estimated **4.7B people globally** have acquired or been affected by fake credentials.

**A SHA-256 hash on Stellar is not forgeable. Verification takes ~5 seconds.** Traditional background checks take days-to-weeks and cost $30–$75 per check.
...
- **Roadmap to 5,000 TPS.** [Stellar.org blog](https://stellar.org/blog/developers/the-road-to-5000-tps-scaling-stellar-in-2025)
- Enterprise rails already live: **PayPal PYUSD**, **Société Générale EUR CoinVertible**, **MoneyGram** cash on/off-ramps. [MEXC News, 2025](https://www.mexc.com/news/317521)
- **Fees under $0.001** and **~5-second finality** make micro-payments economically viable where Ethereum/Solana break.
...
A Filipino freelancer billing a US client today loses ~20% to Fiverr, waits 30–60 days for payment, then another 3–5% to remittance providers. **Stellaroid Earn compresses all three frictions into one sub-second, sub-cent transaction.**
...
A $5 micro-payout on Ethereum L1 costs more than the payout. On Stellar, fees are under $0.001. This unlocks:

- **Micro-tasks** (sub-$10 gigs)
- **Per-deliverable** payment (not per-hour, not per-project)
- **Instant cross-border** (no correspondent-banking tax)
- **Streaming-style** payouts for multi-milestone work

**The unit economics only work on a chain like Stellar.**

### 4. Consumer-grade polish in a Web3 app

The #1 barrier to Web3 adoption is UX. Stellaroid Earn is built to be trusted by users who have never used a wallet:
...
- No ops on-call
- No per-user compute cost

Infrastructure scales with Stellar's fees, not the app's costs. That unlocks price points no Web2 competitor can match.
