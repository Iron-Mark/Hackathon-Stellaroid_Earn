...
- [x] Recaptured `assets/campaign/v320-receipts.png` from the current template so the posting board shows 62 wallet accounts (30 independent plus 32 QA I operate), not the July 54 snapshot.
