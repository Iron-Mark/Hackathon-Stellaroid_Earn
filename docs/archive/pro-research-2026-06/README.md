# Pro-Research Archive - June 2026
...
This folder preserves the closed pro-research intake synthesized from 3 source files. Original source files are copied into `ref/original/`. Duplicate extracted PDF text copies were pruned because the PDFs remain readable source evidence.

Use active planning docs first:

- `../../planning/research-intake-status.md`
- `../../planning/research-gaps.md`
- `../../../ROADMAP.md`

Do not execute these archived plans without revalidating against the current code, active product direction, and live environment.
...
- `Markdown/Deep Research Reports/Stellaroid Earn - Deep Audit.md` - deep-audit - Stellaroid Earn Deep Audit
