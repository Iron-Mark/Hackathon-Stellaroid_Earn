      ...
      <div className="flex flex-col gap-1 w-full">
            ...
            <div className="flex items-center gap-1.5">
              ...
              {tooltip && (
                <span
                  ...
                  tabIndex={0}
                  role="button"
                  aria-label={`More info${label ? ` about ${label}` : ""}`}
                >
                  <svg
        ...
        <input
          ...
          className={cn(
            ...
            "text-[15px] max-lg:text-base text-text placeholder:text-text-muted",
          ...
          aria-describedby={
            [
              errorMessage ? errorId : helper && !tooltip ? helperId : undefined,
